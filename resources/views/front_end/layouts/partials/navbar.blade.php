<div class="bg-white shadow-sm fs-6" style="min-height: 60px; font-family: 'Noto Sans', sans-serif;">
    ...
    <div class="container d-flex align-items-center justify-content-between" style="min-height: 60px;">
...
<style>
    .demo-btn:hover {
        transform: skewX(-10deg); /* inclinaison comme en italique */
        background-color: #001f4d;
        font-style: normal; /* on peut laisser le texte droit */
