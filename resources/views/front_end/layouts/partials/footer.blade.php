...
<footer class="text-light py-5 mt-5" role="contentinfo" style="background-color: #111416;">
    ...
    <div class="row gy-4">
      <div class="col-md-3 d-flex flex-column align-items-start">
        ...
        <p class="small mb-0" style="color:#9CA3AF;">
          ...
          Contact :
          <a href="mailto:support@fluidpay.link" class="footer-link " style="color:#9CA3AF;">support@fluidpay.link. <br> Nous sommes à votre disposition !</a>
        </p>
      </div>
      <div class="col-md-3">
        <h5 class="fw-bold  footer-title">Entreprise</h5>
      ...
      <div class="col-md-3">
        <h5 class="fw-bold  footer-title">Produit</h5>
        <ul class="list-unstyled">
      ...
      <div class="col-md-3" style="font-size: 12px;">
        <h5 class="fw-bold footer-title">Pays</h5>
        <ul class="list-unstyled">
